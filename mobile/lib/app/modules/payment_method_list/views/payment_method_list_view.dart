...
class PaymentMethodListView extends GetView<PaymentMethodListController> {
  const PaymentMethodListView({super.key});
  @override
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: ReusableWidgets.generalAppBarWidget(title: "payment_method".tr),
        ...
        children: [
          ...
          ListComponent(
            ...
            itemBuilder: (item) => ListTile(
              ...
              trailing: TextComponent(value: item.kode),
            ),
          ),
        ],
      ),
