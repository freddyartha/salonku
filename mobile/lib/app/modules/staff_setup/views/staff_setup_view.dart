      ...
      () => ReusableWidgets.generalSetupPageWidget(
        ...
        children: [
          if (!controller.isLoading.value &&
              ...
              controller.model?.approvedDate == null &&
            ...
            Container(
              ...
              child: Column(
                ...
                children: [
                  ...
                  InputRadioComponent(
                    controller: controller.approveCon,
                    label: "approve_staff".tr,
                    required: true,
                  ),
                  GetBuilder<StaffSetupController>(
                    builder: (controller) => SelectMultipleComponent(
                  ...
                  ButtonComponent(
                    onTap: controller.staffApproval,
                    text: "save".tr,
              ...
              child: Column(
                children: [
                  ...
                  InputDatetimeComponent(
                    ...
                    controller: controller.approvedDate,
          ...
          InputTextComponent(
            ...
            required: true,
            editable: controller.localDataSource.userData.level == 1
                ? false
                : controller.isEditable.value,
          ),
          InputTextComponent(
          ...
          Visibility(
            visible:
                ...
                (!controller.isEditable.value &&
                    controller.localDataSource.userData.level == 1),
