  ...
  void initState() {
    ...
    if (widget.initialCountryCode == null && number.startsWith('+')) {
      ...
      _selectedCountry = countries.firstWhere(
          (country) => country.fullCountryCode == number,
      ...
      if (widget.initialCountryCode!.startsWith("+")) {
        var code = widget.initialCountryCode!.substring(1);
        _selectedCountry = _countryList.firstWhere(
            (item) => item.fullCountryCode == code,
            orElse: () => _countryList.first);
      } else {
        _selectedCountry = _countryList.firstWhere(
